...
def readerWriteAContent(request):
        ...
        try:
            ...
            cmd3 = "; git config --local user.email " + readerId + "@gmail.com; "
...
# def writeAContent(request):
#     if "lastUrl" not in request.GET:
#         return render(request, 'reader/login.html')
#
#     lastUrl = request.GET["lastUrl"]
#
...
#     if "readerId" not in request.session:
#         # return render(request, 'reader/login.html', {})
#         return HttpResponseRedirect("/reader/login/?lastUrl=" + lastUrl)
#
