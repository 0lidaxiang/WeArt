  ...
  .done(function(resp) {
    ...
    if (resp.status == "success") {
      ...
      for (var i in bookAll) {
        ...
        obj = obj + "<tr><td>" + lineNumber + "</td><td><a class='alink' href='/chapter/bookChapter/?idBook=" + bookAll[i].id + "&bookName=" + bookAll[i].name + "'>" + bookAll[i].name + "</a></td>" +  "<td>" + bookAll[i].authorName + "</td><td> " + bookAll[i].chapterCount  + "</td></tr>";
      }
